...
using AvaloniaNotifyIcon.Platform.Win.Interop;
using Serilog;
using System;
...
namespace AvaloniaNotifyIcon.Platform.Win
{
    /// <summary>
    ...
    public class SystemEventHelperWindow : NativeWindow
    {
        ...
        public SystemEventHelperWindow(SystemEventNotifier systemEventNotifier) : base()
        {
            ...
            bool success = UnmanagedMethods.WTSRegisterSessionNotification(
                Handle, UnmanagedMethods.NOTIFY_FOR_THIS_SESSION);
        ...
        ~SystemEventHelperWindow()
        {
            ...
            UnmanagedMethods.WTSUnRegisterSessionNotification(Handle);
